...
The goal is to recover the $S$ source components $\bm{x}_s$ from the
measurements $\bm{y}_m$. Since each measurement is a superposition of blurred
sources,
