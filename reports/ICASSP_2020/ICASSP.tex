...
similar resolution \cite{davila2011high}. Since
...
produce conventional reflective optics. Moreover, refractive optics are
...
implementation is analysed and compared with the complexity of the original algorithm. The last
...
In this section, we derive the computational complexity of the original
...
\subsection{Original Implementation Complexity}
